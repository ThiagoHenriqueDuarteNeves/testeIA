...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const ChatModule = (() => {
        ...
        let messages = [
            { role: "system", content: "Você é um assistente bem humorado para atender a Tia Fatima, inclua sempre o tratamento 'Tia Fátima'." }
        ];
        ...
        function appendMessage(sender, text, isAssistant = false) {
            ...
            const senderElem = document.createElement("span");// app.js
            document.addEventListener("DOMContentLoaded", function () {
                // Módulo de Conexão
                const ConnectionModule = (() => {
                    const connectionIcon = document.getElementById("connectionIcon");
                    const connectionText = document.getElementById("connectionText");
                    const serverURL = "http://5417-2804-d41-c571-5c00-f8f0-7fda-a307-d9dd.ngrok-free.app";
                    let checkConnectionInterval = null;
